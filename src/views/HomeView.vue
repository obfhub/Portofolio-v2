<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Deminschii Arcadie</h1>
      <div class="py-2">
        <h1
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-64 h-64 md:w-[300px] md:h-[300px] rounded-full border-4 border-amber-200 object-cover object-top pict" src="/img/c.webp">
    </div>
  </main>
</template>
